    ...
    static applymapping(TransformTask proguardTask, File mappingFile) {
        if (proguardTask) {
            ...
            if (mappingFile.exists()) {
                ...
                FixLogger.i("${mappingFile} does not exist")
            }
        }
    }
